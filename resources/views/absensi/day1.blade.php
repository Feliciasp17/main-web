...
<header class="full-screen d-lg-flex jumbotron jumbotron-fluid">
    <div class="container-fluid text-center"> 
        ...
        <p class="lead pb-4 textket">
           TEKAN TOMBOL ABSEN UNTUK MENDAPATKAN LINK DAY 1!
        </p>
		<p class="lead pb-4 final-btn">
			<a href="#" class="btn mr-lg-2 custom-btn">ABSENSI DAY 1</a>
		</p>
        <p class="lead pb-4 final-btn">
			Silahkan klik tombol LINK DAY 1, Selamat datang peserta CEG 2021.
            &nbsp;
            <a href="#" class="btn mr-lg-2 custom-btn">LINK DAY 1</a>
            <p>
